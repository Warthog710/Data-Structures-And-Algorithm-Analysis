public class Client {
    ...
    private static void testMultiplePopsElems()
    {
        ...
        System.out.println(stack);
        Integer eight = stack.peek();
        stack.pop();

        System.out.println("Eight: " + eight);
        System.out.println(stack);
        Integer seven = stack.peek();
        stack.pop();

        System.out.println("Seven: " + seven);
        System.out.println(stack);
        Integer six = stack.peek();
        stack.pop();
    ...
    private static void testSimplePopElems() {
        ...
        System.out.println("The popped element should be an 8 and is: " + lastElement);
        System.out.println(stack);
    }

    //Testing pushing 9 elements onto the stack
